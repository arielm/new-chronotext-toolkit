...
gl::Texture* TextureHelper::loadTexture(DataSourceRef source, bool useMipmap, int filter, GLenum wrapS, GLenum wrapT)
{
    ...
    switch (filter)
    {
        ...
        default:
            texture = new gl::Texture(loadImage(source), format);
            break;
    }
