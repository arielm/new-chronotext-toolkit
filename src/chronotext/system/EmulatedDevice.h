...
namespace chronotext
{
    struct EmulatedDevice
    {
        ...
        EmulatedDevice(int width, int height, float diagonal, float contentScale = 1)
        :
        size(width, height),
        diagonal(diagonal),
    ...
    static EmulatedDevice DEVICE_IPHONE_3GS_PORTRAIT = EmulatedDevice(320, 480, 3.54f);
    static EmulatedDevice DEVICE_IPHONE_4_PORTRAIT = EmulatedDevice(640, 960, 3.54f);
    static EmulatedDevice DEVICE_IPHONE_5_PORTRAIT = EmulatedDevice(640, 1136, 4.0f);
    ...
    static EmulatedDevice DEVICE_GALAXY_S_PORTRAIT = EmulatedDevice(480, 800, 4.0f);
    ...
    static EmulatedDevice DEVICE_XOOM_1_PORTRAIT = EmulatedDevice(752, 1280, 10.08f);
}
